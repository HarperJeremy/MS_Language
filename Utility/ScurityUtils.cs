...
namespace MS_Language.Utility {
    public class SecurityUtils {
        ...
        public static string CreateUserSecurityKey(string userName, string password, string companyId) {
            var time = DateTime.Now;
            var stringToEncrypt = companyId + "||" + userName + "||" + password + "||" + time.ToString(Constants.SecurityTokenDateFormat);
